...
EqTrayKCEOS2Alt(Trays,Comp,Str,Str2)$(ETrV(Trays,Str) AND ETrL(Trays,Str2))..
  Kt(Trays,Comp)*phiEOS(Str,Comp) =e= phiEOS(Str2,Comp) + Kslack(Trays,Comp);

EqTrayKCEOS2(Trays,Comp,Str,Str2)$(ETrV(Trays,Str) AND ETrL(Trays,Str2))..
...
EqNumStages(Ed1)..
  NumTrays(Ed1) =e= SUM(Trays$TrayCasc(Ed1,Trays), eff(Trays));
...
Model TrayEqnsWithBypass /EqTrayPEquilib, EqTrayPDrop, EqTrayConstPres,
                         ...
                         EqTrayMassBal2, EqTrayEnrgBal2, EqTrayXcEquilib2, EqTrayTEquilib2, EqTrayPEquilib2/;

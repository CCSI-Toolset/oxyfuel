...
Sets
  ...
  c              components      /A*B/
  u              units           /1*3/
  Inlet(u,s)     inlet streams   /(1.S2), (2.S5), (3.S4)/
  OutletV(u,s)   outlet vapor    /(1.S3), (2.S6), (3.S8)/
  OutletL(u,s)   outlet liquid   /(1.S4), (2.S7), (3.S9)/
...
Scalars
  A_recoverySpec Recovery spec           /0.9/
  A_puritySpec   Purity spec             /0.551/;

Parameter
  ECost(u)       Equipment operating cost        /1 = 1.5, 2 = 1.0, 3 = 0.5/;
...
EqObj1..
  Obj =e= SUM(u, SUM(s$Inlet(u,s), F(s)*ECost(u)));
...
Parameter vInit(u)       /1 = 0.5, 2 = 0.95, 3= 0.5/;
